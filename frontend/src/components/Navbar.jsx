...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 bg-purple-600 dark:bg-gray-900 shadow-lg px-4 py-3 flex justify-between items-center transition-colors duration-300 backdrop-blur-lg">
      ...
      <div className="flex gap-4 items-center">
        ...
        >
          {theme === "dark" ? (
            ...
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12.79A9 9 0 1111.21 3a7 7 0 109.79 9.79z" /></svg>
          )}
        </button>
